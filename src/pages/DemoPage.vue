<template>
    <div class="text-bg-white min-vh-100 top-padding">
                ...
                <div class="col-12 col-md-6 border bg-light p-3 mt-5 mt-md-0">
                    ...
                    <form @submit.prevent="submitQuery()" class="mt-4 row g-3 needs-validation">
                        <div class="w-100 form-floating mt-0">
                            <input type="text" class="form-control border-secondary" placeholder=""
                                v-model="name" required>
                            <label for="floatingInput" class="text-secondary ms-2">Name</label>
                        </div>
                        <div class="w-50 form-floating mt-2">
                            <input type="tel" class="form-control border-secondary" placeholder="Mobile"
                                v-model="number" required>
                            <label class="ms-2 text-secondary">Mobile No</label>
                        </div>
                        <div class="mt-2 w-50">
                            <select class="form-select py-3 border-secondary" name="CompanyCountry"
                                v-model="selectedCountry" aria-required="true" required="true">
                        ...
                        <div class="w-100 form-floating mt-2">
                            <textarea class="form-control border-secondary" placeholder="Leave a comment here"
                        ...
                        <div class="form-check text-start ms-2">
                            ...
                            <label class="form-check-label small text-secondary" for="flexCheckDefault">
                                I agree to the <router-link to="/term-of-use" class="text-dark text-capitalize">terms
                                    and
        ...
        <p class="text-center py-4 mb-0 position-fixed bottom-0 w-100 "
            style="color: var(--brand-color) !important; background-color: #000 !important;">Questions? Talk to an
            expert: 918802172121</p>
    </div>
</template>
<script>
export default {
    data() {
        return {
            links: [
                "Arrange your live and personalized demo of Covisor Biz.",
                "Explian you how Covisor Biz can help you to grow your business.",
