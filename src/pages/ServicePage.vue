...
<script>
import ServicesFormBanner from "@/components/FormBanner.vue";
import ServicesLeadManagement from "@/components/LeadManagement.vue";
import WhyChooseUs from "@/components/WhyChooseUs.vue";
import AutoScrolling from "@/components/AutoScrolling.vue"; 
import ServicesSalesCounter from "@/components/SalesCounter.vue";
